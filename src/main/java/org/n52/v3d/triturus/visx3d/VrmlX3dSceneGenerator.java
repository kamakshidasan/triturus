    ...
    public void writeToX3dFile(String pFilename, boolean pX3dom)
    {
        ...
        try {
            ...
            if (pX3dom) {
                ...
                wl("      function restoreViewpoint(){");
                wl("	    var e = document.getElementById('x3d');");
                wl("	    e.runtime.showAll();");
                wl("      }");
                wl("    </script>");
                wl("  </head>");
                wl("  <body>");
                ...
                wl("    </p>");
                wl();
                wl("<X3D id= 'x3d' xmlns=\"http://www.web3d.org/specifications/x3d-namespace\" showStat=\"false\" showLog=\"false\"");
            ...
            if (pX3dom) {
                wl();
                wl("  <input type=\"submit\" value=\"Restore Viewpoint\" onclick=\"restoreViewpoint()\">");
                wl("  </body>");
                wl("</html>");
            }
